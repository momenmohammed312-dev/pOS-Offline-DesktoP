# 🏪 نظام نقاط البيع المتقدم (POS)

**Developed by MO2**  
**نسخة 1.0.0**  
**Flutter 3.32.5 | Java 17**

---

## 📋 نظرة عامة

نظام نقاط البيع المتقدم هو حل شامل لإدارة المبيعات، العملاء، الموردين، والمصروفات. يتميز بواجهة مستخدم عربية سهلة الاستخدام مع دعم كامل للعملة المصرية والطباعة الذكية.
...
color: Colors.red.withValues(alpha: 0.3)  // بدلاً من withOpacity()
initialValue: selectedValue               // بدلاً من value
activeThumbColor: Colors.orange          // بدلاً من activeColor
```

#### ❌ الممارسات التي يجب تجنبها
```dart
// لا تستخدم context عبر فجوات غير متزامنة
await someAsyncOperation();
...
- [ ] الأنواع غير قابلة للقيمة الفارغة حيثما أمكن
